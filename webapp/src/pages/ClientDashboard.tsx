...
const ClientDashboard: React.FC<ClientDashboardProps> = ({ onShowCreate, refreshKey }) => {
  const { token } = useAuth();
              ...
              {clients.map((client) => (
                <tr key={client._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button onClick={() => alert('Edit ' + client._id)} className="text-indigo-600 hover:text-indigo-900 mr-4">Edit</button>
